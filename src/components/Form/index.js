...
export default class Form extends Component {
  ...
  submitReview = (e) => {
    ...
    this.props.store.ReviewList.map((e, i) =>{
      let obj={index: i, review:e.review,stars:e.stars};

    console.log(`${obj.index}: got score- ${obj.stars} and content: ${obj.review}`)}
    );

    
      // this.props.store.ReviewList);
  };
